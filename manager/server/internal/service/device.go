...
type (
	IDevice interface {
		...
		GetDeviceInfoListPagination(ctx context.Context, page int, pageSize int, nameOrId ...string) (list []*model.DeviceInfo, total int, err error)
		DownloadDevicePubKey(ctx context.Context, deviceId string) (pub string, err error)
